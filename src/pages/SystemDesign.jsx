  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`sidebar-toggle absolute z-30 top-4 left-4 transition-all
          duration-300 bg-white p-2.5 rounded-lg shadow-lg border border-slate-200
          hover:bg-slate-50 hover:shadow-xl active:scale-95`}
      ...
      <AnimatePresence>
        {isSidebarOpen && (
          <motion.aside
            ...
            className="w-72 absolute md:relative z-20 h-full bg-white border-r border-slate-200 flex flex-col shadow-xl"
          >
